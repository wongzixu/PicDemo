...
class PictureSearchViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func searchButtonTapped(_ sender: UIButton) {
        self.performSegue(withIdentifier: K.segues.photoToImage, sender: self)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        print("prepare")
       
        if segue.identifier == K.segues.photoToImage {
